...
namespace Core.UnrealStream.Tests
{
    public class StreamExtensionsTests
    {
        ...
        /// <returns></returns>
        byte[] GetBytesFromStringWithZeroTermination(string value)
        {
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        string GetStringFromZeroTerminatedBytes(byte[] value)
        {
            return Encoding.ASCII.GetString(new ArraySegment<byte>(value, 0, value.Length - 1));
        }

        [Fact]
        void CreateZeroTerminatedStringBytes()
        {
            // Arrange
            var s = "test";
            // Act
        ...
        [Fact]
        void GetZeroTerminatedStringFromBytes()
        {
            // Arrange
